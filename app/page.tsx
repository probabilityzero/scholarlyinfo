    ...
    <div className="container mx-auto py-12 px-4">
      ...
      <div className="bg-card rounded-xl p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/academic-partners" className="text-muted-foreground hover:text-primary transition-colors">
              Academic Partners
            </Link>
          </div>
          <div className="flex items-center gap-3">
      ...
      <div className="bg-primary/5 rounded-3xl p-10 md:p-16 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4">
          <a href="https://scholarly.world/search" className="inline-block">
            <Button className="min-w-[180px]">
              Start Searching
            </Button>
          </a>
          <a href="https://scholarly.world/library" className="inline-block">
